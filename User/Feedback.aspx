        ...
        <tr>
            <td>
                <table class="auto-style2">
                    <tr>
                        <td class="auto-style3"><strong><em>Select question</em></strong></td>
                        <td class="auto-style4">
                            <asp:DropDownList ID="drpQuestion" runat="server" Style="font-weight: 700">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td class="auto-style3"><strong><em>Type your answer</em></strong></td>
                        <td class="auto-style4">
